function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./saddle-animation-vertex-animation-texture-example-crowd_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('saddle-animation-vertex-animation-texture-example-crowd_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
